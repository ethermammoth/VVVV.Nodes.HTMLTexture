...
namespace VVVV.Nodes.Texture.HTML
{
    public class HTMLTextureRenderer : IDisposable
    {
        ...
        private bool FDisablePopups = false;
        ...
        public void ReloadIC()
        {
            FBrowser.ReloadIgnoreCache();
        }
        ...
        public void SetPopUpBehaviour(bool status)
        {
            FDisablePopups = status;
        }

        public bool GetPopUpBehaviour()
        {
            return FDisablePopups;
        }
